...
xst -ifn xst.scr
move DCM_gen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\DCM_gen.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DCM_gen.ucf DCM_gen_exdes

echo 'Running map'
map -timing -pr b DCM_gen_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DCM_gen_exdes -w routed.ncd routed.vhd
cd ..
